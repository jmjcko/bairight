    ...
    parameters: [
      {
        ...
        suggestedValues: [
          ...
          'Nerezová ocel s dvojitou stěnou (nerozbitná konstrukce na cestování a do auta)',
          'Borosilikátové dvoustěnné sklo (termo efekt s vizuálním zážitkem)',
          'Tvrzené sklo / Smalt',
        ],
      },
      {
        id: 'thermal_insulation',
        name: 'Tepelná izolace & Udržení teploty',
        ...
        suggestedValues: [
          ...
          'Dvoustěnné provedení bez vakua (ochrana rukou před popálením, teplo cca 1-2 hodiny)',
          'Jednostěnné běžné provedení (klasické domácí používání)',
        ],
      },
      {
        id: 'volume_capacity',
        ...
        suggestedValues: [
          ...
          'Standardní objem 300–400 ml (univerzální hrnek na kávu i čaj)',
          'Kompaktní objem 80–200 ml (na espresso, doppio či flat white)',
        ],
      },
      {
        id: 'dishwasher_microwave',
        name: 'Odolnost pro myčku a mikrovlnku',
        ...
        suggestedValues: [
          ...
          'Pouze ruční mytí (citlivý potisk, lakování nebo termo mechanizmus)',
          'Vhodné do mikrovlnné trouby bez kovu',
        ],
      },
      {
        id: 'lid_seal_leakproof',
        name: 'Víčko a těsnost proti vylití',
        ...
        suggestedValues: [
          ...
          'Víčko s pítkem proti stříkání v autě (není určené na obracení dnem vzhůru)',
          'Bez víčka (klasický otevřený hrnek)',
        ],
      },
      {
        id: 'ergonomics_handle',
        name: 'Ergonomie ucha a úchop',
        category: 'Ergonomie',
        importance: 'recommended',
        ...
        suggestedValues: [
          ...
          'Silikonový nebo gumový protiskluzový návlek bez ucha',
          'Jednoduché ucho na 2 prsty',
        ],
      },
    ...
    questions: [
      {
        id: 'drinkware_q_type',
        step: 1,
        title: 'Pro jaký účel a nápoj hrnek či nádobí vybíráte?',
        subtitle: 'Určuje typ materiálu, těsnění a požadavky na izolaci.',
        component: 'chips',
        isMultiSelect: false,
        options: [
          { label: 'Domácí a kancelářské pití kávy/čaje', value: 'home_office', description: 'Klasické keramické či porculánové hrnky.' },
          { label: 'Cestování a auto (termohrnek)', value: 'travel_car', description: 'Nerezový termohrnek s těsným víčkem a vakuovou izolací.' },
          { label: 'Stylový dárkový nebo designový kousek', value: 'design_gift', description: 'Dvoustěnné sklo, originální motiv či ruční keramika.' },
        ],
        defaultValue: 'home_office',
        promptForgeTemplate: '- **Účel použití hrnku:** {value}',
      },
    ],
    suggestedAlternatives: [
      {
        id: 'drinkware_car_holder',
        name: 'Vhodnost do držáku nápojů v autě',
        category: 'Cestování',
        ...
        suggestedValues: [
          ...
          'Standardní průměr dna',
        ],
      },
    ],
    systemPrompt: `Jsi expertní poradce pro stolní nádobí, sklo a termohrnky.
Doporuč přesně 3 kvalitní modely hrnků či nádobí dle materiálu, objemu, izolačních vlastností a nároků na údržbu.`,
  },
  apparel_fashion: {
    keywords: [
    ...
    parameters: [
      {
        ...
        suggestedValues: [
          ...
          'Straight Regular Fit (klasický rovný střih)',
          'Slim Fit (přiléhavější moderní střih)',
          'Tapered Fit (postupně se zmenšující k kotníkům)',
        ],
      },
      {
        id: 'apparel_waist_rise',
        name: 'Výška pasu',
        ...
        suggestedValues: [
          ...
          'Střední pas (Mid rise - klasické pohodlné nošení)',
          'Nízký pas (Low rise - snížený bokový pas)',
        ],
      },
      {
        id: 'apparel_material_weight',
        name: 'Materiál & Gramáž denimu',
        category: 'Materiál & Kvalita',
        importance: 'mandatory',
        ...
        suggestedValues: [
          ...
          'Denim s elastanem (2–3 % spandex pro pružnost a komfort)',
          'Bio bavlna / Udržitelný recyklovaný denim',
        ],
      },
      {
        id: 'apparel_size_proportions',
        name: 'Velikost a dimenzování',
        ...
        suggestedValues: [
          ...
          'Oversize sizing (doporučeno vzít o číslo menší pro běžný fit)',
          'Přesné rozměry v cm (obvod pasu, boků a šířka stehna)',
        ],
      },
      {
        id: 'apparel_length_leg',
        name: 'Délka & Úprava nohavic',
        ...
        suggestedValues: [
          ...
          'Standardní délka (akorát k hornímu okraji boty)',
          'Zkrácená délka / Ankle crop (nad kotníky)',
        ],
      },
      {
        id: 'apparel_wash_color',
        name: 'Odstín & Úprava praní',
        ...
        suggestedValues: [
          ...
          'Mid / Vintage Wash (středně modrá s patinou)',
          'Raw / Dark Indigo (tmavá surová neseplá džínovina)',
          'Černá / Šedá washed (černý stonewash denim)',
        ],
      },
      {
        ...
        suggestedValues: [
          ...
          'Kvalitní kovový zip YKK (Quick Zip)',
          'Pružná guma v pase se šňůrkou (Jogger / Elastic waist)',
        ],
      },
      {
        id: 'apparel_maintenance_wash',
        name: 'Péče & Stálobarevnost',
        category: 'Údržba',
        importance: 'recommended',
        ...
        suggestedValues: [
          ...
          'Šetrné praní na 30°C naruby (ochrana barvy)',
          'Raw denim (postupné patinování nošením)',
        ],
      },
      UNIVERSAL_BRAND_PARAMETER,
    ],
    questions: [
      {
        id: 'apparel_q_fit',
        step: 1,
        title: 'Jaký střih a siluetu džínoviny / kalhot preferujete?',
        subtitle: 'Základní volba určující šířku nohavic a celkový styl.',
        component: 'chips',
        isMultiSelect: false,
        options: [
          { label: 'Baggy / Loose Fit (volné oversize nohavice)', value: 'baggy', description: 'Maximum pohodlí a široká silueta.' },
          { label: 'Straight Regular Fit (klasické rovné nohavice)', value: 'straight', description: 'Tradiční univerzální střih.' },
          { label: 'Slim / Tapered Fit (zúžené nohavice)', value: 'slim', description: 'Moderní přiléhavější kroj.' },
        ],
        defaultValue: 'baggy',
        promptForgeTemplate: '- **Preferovaný střih:** {value}',
      },
    ],
    suggestedAlternatives: [
      {
        id: 'apparel_reinforcement',
        name: 'Zesílené nýty a švy',
        ...
        suggestedValues: [
          ...
          'Standardní dvojité šití',
        ],
      },
    ],
    systemPrompt: `Jsi expertní stylistický a produktový nákupčí pro oblečení a džínovinu.
Doporuč přesně 3 kvalitní modely džínoviny / kalhot dle zadaného střihu, materiálu, výšky pasu a rozpočtu.`,
  },
  electric_cars: {
    keywords: [
